...
namespace Assignment_2
{
    public partial class MyProfile : System.Web.UI.Page
    {
         ...
         * in the text boxes on "MyProfile"-page*/
        public void DisplayCustomerDataToBeUpdated() 
        {
            ...
            /*Change the color of the text in the text box back to the basic gray ("not updated")
            ...
            string userID = Session["UserAuthentication"].ToString();
         ...
         * on the "MyProfile"-page, and display a successful-message in the UpdateProfileLabel 
        ...
        protected void UpdateProfileButton_Click(object sender, EventArgs e)
        {
            if (IsValid)
            {
                ...
                UpdateProfileLabel.Text = "Profile updated successfully!";
                UpdateProfileLabel.Visible = true;
            }
            else 
            {
                UpdateProfileLabel.ForeColor = System.Drawing.Color.Crimson;
                UpdateProfileLabel.Text = "Error: Profile did not get updated!";
                UpdateProfileLabel.Visible = true;
            }
