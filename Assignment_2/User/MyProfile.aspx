<%@ Page Title="" Language="C#" MasterPageFile="~/Style/MasterPage.Master" AutoEventWireup="true" CodeBehind="MyProfile.aspx.cs" Inherits="Assignment_2.MyProfile" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1>My Profile</h1>
    <asp:Panel ID="UpdateProfilePanel" runat="server" GroupingText="Update Profile">
            <p>
                Update your details as required.</p>
   ...
   <table width="700px">
    ...
    <p></p>
        <asp:Button ID="UpdateProfileButton" runat="server" Text="Update Profile" OnClick="UpdateProfileButton_Click" ValidationGroup="UpdateProfileValGroup" />
        <asp:Label ID="UpdateProfileLabel" runat="server" ForeColor="#009900" Visible="False"></asp:Label>
    </asp:Panel>

    <br />
    <asp:Panel ID="ChangePasswordPanel" runat="server" GroupingText="Change Password">
        <br />
